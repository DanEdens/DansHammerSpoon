...
hs.hotkey.bind(hammer, "F8", "Reset Shuffle Counters", function() WindowManager.resetShuffleCounters() end)
hs.hotkey.bind(_hyper, "F8", "Show Monitor Info", function() WindowManager.showMonitorInfo() end)
hs.hotkey.bind(hammer, "F9", "Half Shuffle", function() WindowManager.halfShuffle() end)
hs.hotkey.bind(_hyper, "F9", "Refresh Layouts", function() WindowManager.refreshLayouts() end)
...
hs.hotkey.bind(_hyper, "F12", "Mini Shuffle", function() WindowManager.miniShuffle() end)
