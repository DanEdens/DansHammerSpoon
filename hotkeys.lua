...
hs.hotkey.bind(hammer, "F11", "Show Window Config Info", function() WindowToggler.showConfigurationInfo() end)
hs.hotkey.bind(_hyper, "F11", "Refresh Window Config", function() WindowToggler.refreshConfiguration() end)
