...
hs.hotkey.bind(_hyper, "4", function() moveWindow95By30FromRightSide() end)                                      -- _hyper 4     -- Move window to 95 by 30 from right side
...
--hs.hotkey.bind(_hyper, "8",  function() tempFunction() end)                                                      -- hammer 6     -- smaller left side
